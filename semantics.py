...
def sem(tr):
    ...
    # add more code here
#\x.exists y.((y = Eric) & T_like(y,x))
#\x.exists y.(Eric(y) & T_like(y,x))
#<LambdaExpression \x.exists y.((\x.(x = Eric))(y) & ((\x y.T_like(x,y))(y))(x))>

#  improvement , cant ask Which bird is ugly and clever?
# cant have mary swims and flies. 2 verbs
# cannot have Eric is an ugly bird.
#Eric likes John and Mary.#
#Cannot have negation.
#Who does Eric like who likes Tia? cannot happen
